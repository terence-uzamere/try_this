...
urlpatterns = patterns('',
  ...
  url(r'^suggestion/(?P<suggestion_pk>\d+)/comment/update/(?P<comment_pk>\d+)/$', CommentUpdateView.as_view(), name='comment_update'),
  url(r'^suggestion/(?P<suggestion_pk>\d+)/comment/delete/(?P<comment_pk>\d+)/$', CommentDeleteView.as_view(), name='comment_delete'),
)
